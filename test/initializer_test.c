...
int main() {
  ...
  ASSERT(10, ({
    int x[2][3] = {1, 2, 3, 4, 5, 6, [0][1] = 7, 8, [0] = 9, [0] = 10, 11, [1][0] = 12};  // NOLINT
    x[0][0];
  }));
  ASSERT(11, ({
    int x[2][3] = {1, 2, 3, 4, 5, 6, [0][1] = 7, 8, [0] = 9, [0] = 10, 11, [1][0] = 12};  // NOLINT
  ...
  ASSERT(7, ({
    int x[2][3] = {1, 2, 3, 4, 5, 6, [0] = {7, 8}, 9, 10};  // NOLINT
    x[0][0];
  }));
  ASSERT(8, ({
    int x[2][3] = {1, 2, 3, 4, 5, 6, [0] = {7, 8}, 9, 10};  // NOLINT
  ...
  ASSERT(7, ((int[10]){[3] 7})[3]);  // NOLINT
  ASSERT(0, ((int[10]){[3] 7})[4]);  // NOLINT

  ASSERT(4, ({
    struct {
      int a, b;
    } x = {1, 2, .b = 3, .a = 4};  // NOLINT
    x.a;
  }));
  ASSERT(3, ({
    struct {
