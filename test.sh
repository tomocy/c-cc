...
assert 41 'main() { int z; z =  12 + 34 - 5 ; }'
assert 3 'main() { 1;2;3; }'
assert 1 'main() { int a; a=1; a; }'
assert 41 'main() { int z;z =  12 + 34 - 5 ;z; }'
assert 2 'main() { int foo; foo = 2; }'
assert 5 'main() { int foo; foo = 2; int bar; bar = foo; bar + 3; }'
assert 8 'main() { return 8; }'
assert 5 'main() { return 5; return 8; }'
assert 3 'main() { int returnx; returnx = 3; }'
assert 5 'main() { int a; a=1; if (a) 5; }'
assert 4 'main() { int a; a=0; if (a) 5; else 4; }'
assert 5 'main() { int i; i=0; while (i < 5) i = i + 1; }'
assert 3 'main() { int i; i=3; while (0) i = i + 1; }'
assert 5 'main() { int i; for (i=0; i < 5; i = i + 1) i; }'
assert 4 'main() { { {2;} {3;} 4; } }'
assert 1 'main() { { int a; a = 0; int b; b = a; int c; c = b; return a == c; } }'
assert 5 'main() { int i; i=0; while (i < 5) { i = i + 1; } }'
assert 5 'main() { test(); }'
...
assert 3 'a() { int c; c=1; } add(a, b) { return a+b; } main() { return add(1, 2); }'
...
assert 5 'main() { int x; x = 3; int y; y = &x; *y = 5; return x; }'
